...
p <- ggplot(plot_data, aes(x = TradingDay, y = Equity, color = Period)) +
  ...
  labs(title = "Rolling 6-Year Performance Analysis",
       subtitle = "Advanced Reversal Strategy + Stoch(14,7)",
       y = "Portfolio Equity ($)",
...
ggsave("./outputs/portfolio_rolling_6yr.png", plot = p, width = 12, height = 7)
cat("Done! Chart saved to outputs/portfolio_rolling_6yr.png\n")
