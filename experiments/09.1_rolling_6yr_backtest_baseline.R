...
p <- ggplot(plot_data, aes(x = TradingDay, y = Equity, color = Period)) +
  ...
  theme_minimal() +
  labs(title = "Rolling 6-Year Performance Analysis",
       subtitle = "Advanced Reversal Strategy (Baseline - No Stoch)",
       y = "Portfolio Equity ($)",
...
ggsave("./outputs/portfolio_rolling_6yr_baseline.png", plot = p, width = 12, height = 7)
cat("Done! Chart saved to outputs/portfolio_rolling_6yr_baseline.png\n")
