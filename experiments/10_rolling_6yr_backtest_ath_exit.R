# 10_rolling_6yr_backtest_ath_exit.R
# Advanced Reversion Strategy - 6-Year Rolling Periods with ATH/No Exit (2000-2026) - US Market
...
cat("\n========================================================================\n")
cat("Final Equities ($) by 6-Year Period & Strategy (US Market):\n")
...
p <- ggplot(plot_data, aes(x = TradingDay, y = Equity, color = Strategy)) +
  ...
  theme_minimal() +
  labs(title = "Rolling 6-Year Performance Comparison - US Market",
...
ggsave("outputs/portfolio_rolling_6yr_ath.png", plot = p, width = 14, height = 9)
cat("Done! Chart saved to outputs/portfolio_rolling_6yr_ath.png\n")
