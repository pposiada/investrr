# 10_savings_10yr_backtest_pl.R
# Advanced Reversion Strategy - 10-Year Savings Backtest (2016-2026) - Polish Market
...
cat("\n========================================================================\n")
cat("10-Year Savings Backtest Results (2016-2026) - Polish Market:\n")
...
p <- ggplot(plot_data, aes(x = Date, y = Equity, color = Strategy)) +
  ...
  theme_minimal() +
  labs(title = "10-Year Savings Strategy Performance - Polish Market",
...
ggsave("outputs/portfolio_savings_10yr_pl.png", plot = p, width = 12, height = 7)
cat("Done! Chart saved to outputs/portfolio_savings_10yr_pl.png\n")
